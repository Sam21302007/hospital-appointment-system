...
const getPort = detectPort && typeof detectPort === 'function' ? detectPort : detectPort.default;
...
// Seed data function helper — idempotent: creates missing demo accounts every startup
const seedDatabase = async () => {
  try {
    ...
    console.log('🌱 Checking demo accounts in MongoDB...');
    ...
    if (recCount === 0) {
      ...
      console.log('✅ Auto-seeded 5 patient medical records');
    }

    const totalUsers = await User.countDocuments();
    console.log(`✅ Seeding completed! (${totalUsers} users in database, ${created} new this startup)`);
